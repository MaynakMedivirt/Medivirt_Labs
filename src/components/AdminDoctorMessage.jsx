                ...
                <div className="container mx-auto px-5 md:px-3 h-full overflow-y-scroll overflow-x-scroll">
                    <div className="border mt-4 p-2">
                        ...
                        <div className="flex justify-between items-center mb-5">
                            <h2 className="text-center text-3xl font-bold">Doctor Message</h2>
                        </div>
                        ...
                        <div className="overflow-auto mt-3">
                            {message.length > 0 ? (
                                    ...
                                    <tbody className="bg-white text-sm divide-y divide-gray-200">
                                        {message.map((message, index) => (
                                            <tr key={message.id} className="border-b border-gray-200">
                                                ...
                                                <td className="px-2 py-2 bg-gray-50  font-bold text-gray-900 bg-gray-50">
                                                    {message.doctorName}
                                                </td>
                                                <td scope="row" className="px-2 py-2">
                                                    {message.companyName}
                                ...
                                <p>No messages sent by companies.</p>
                            )}
                        </div>
                    </div>
                </div>
...
export default AdminDoctorMessage;
