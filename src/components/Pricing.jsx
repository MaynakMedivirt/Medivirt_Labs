    ...
    <>
      ...
      <section className="bg-white py-5">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 xl:mt-[4rem] lg:mt-[4rem] mb-6 max-w-8xl mx-auto">
            {/* Pricing plan cards */}
            <div className="flex flex-col border px-10 py-12 mt-4 text-base bg-white rounded-xl shadow-sm max-w-[329px] text-black">
              <div id="cardname" className="text-4xl font-bold font-[K2D] text-indigo-500">
                STARTUP
              </div>
              <div className="mt-4 leading-5 capitalize">
                FOR EARLY STARTUPS - <br />
                <p className="font-bold">5 CREDITS</p>
              </div>
              <div id="cardinr" className="mt-[1rem] text-4xl font-bold font-[K2D] leading-10 text-indigo-400">
                Rs. 1999/-
              </div>
            ...
            <div className="flex flex-col border mt-4 px-10 py-12 text-base bg-white rounded-xl shadow-sm max-w-[329px] ">
              ...
              <div id="cardinr" className="mt-4 text-4xl font-bold font-[K2D]  leading-10 text-indigo-400">
                Rs. 4499/-
              </div>
              <div className="flex gap-0.5 mt-11 capitalize">
                <img
              ...
              <div id="cardbuy2" className="flex flex-col  mt-[3.9rem] ml-3 text-lg font-semibold text-center text-white capitalize bg-indigo-800">
                <button className="text-center px-12 py-3.5 bg-indigo-400 hover:bg-indigo-500 transition-all duration-300 ease-in-out">
                  Buy Now
                </button>
              </div>
            </div>
            <div className="flex flex-col border px-10 py-12 text-base bg-[#F9EDEF] rounded-xl shadow-sm max-w-[329px] mb-[2rem]">
              {" "}
              {/* Add custom class and margin-top */}
              <div id="cardname" className="text-4xl font-bold font-[K2D]  text-indigo-500">
                ECONOMY
              </div>
              <div className="mt-4 leading-5 capitalize">
                FOR ESTABLISED COMPANIES -{" "}
              ...
              <div id="cardbuy3" className="flex flex-col  mt-[3.9rem] ml-3 text-lg font-semibold text-center text-white capitalize bg-indigo-800">
                <button className="text-center px-12 py-3.5 bg-indigo-400 hover:bg-indigo-500 transition-all duration-300 ease-in-out">
                  Buy Now
                </button>
              </div>
            ...
            <div className="flex flex-col border  px-10 py-12 mt-4 text-base bg-white rounded-xl shadow-sm max-w-[329px] ">
              ...
              <div className="mt-4 leading-5 capitalize">
                FOR ESTABLISED COMPANIES -{" "}
                <p className="font-bold">40 CREDITS</p>
              </div>
              <div id="cardinr" className="mt-4 text-4xl font-bold font-[K2D]  leading-10 text-indigo-400">
                Rs. 9999/-
              </div>
              ...
              <div id="cardbuy4" className="flex flex-col  mt-[3.9rem] ml-3 text-lg font-semibold text-center text-white capitalize bg-indigo-800">
                <button className="text-center px-12 py-3.5 bg-indigo-400 hover:bg-indigo-500 transition-all duration-300 ease-in-out">
                  Buy Now
                </button>
              </div>
          ...
          <div className="flex flex-col border border-gray-200 shadow-lg md:flex-row md:gap-6">
            <div className="flex flex-col mt-6 w-full md:w-[60%]">
              <div className="flex flex-col grow px-6 py-1 md:ml-0">
                <div className="text-[2.25rem] leading-9 text-zinc-500">
                  Find the pricing plan <br />
                  that suits your needs.
                </div>
                <div className="flex flex-col px-4 py-7 mt-10 md:mt-20 text-white bg-[#3D52A1]">
                  <div className="mt-10 md:mt-16 text-2xl md:text-4xl leading-9 uppercase">
                    Flexible options
                    <br />
                  ...
                  <div className="mt-5 mb-12 text-sm md:text-base leading-6">
                    Uncover the ideal pricing plan to supercharge your <br />
                    sales journey with medivirt. Tailored to your
                    <br />
                    needs, our flexible options ensure cost-efficient <br />{" "}
                    operations without compromising on performance.
                    <br /> For more information email us at:{" "}
                    <p className="font-bold">meet@medivirt.com</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex flex-col ml-0 md:ml-5 w-full mt-6 md:w-6/12">
              <div className="flex flex-col grow px-5 py-1 text-base font-semibold leading-5 text-zinc-500">
                ...
                <div className="self-center mt-5 text-2xl md:text-4xl text-center leading-[34px] md:leading-[54px]">
                  How can we help you?
                </div>
                ...
                ></textarea>
                <div
                  className="flex justify-center items-center px-16 py-6 mt-4 font-bold text-center text-white uppercase whitespace-nowrap bg-[#3D52A1] hover:bg-indigo-500 tracking-[2px] w-full md:w-[213px] md:px-5 cursor-pointer transition-all duration-300 ease-in-out"
