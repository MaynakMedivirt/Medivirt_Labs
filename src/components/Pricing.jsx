          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 xl:mt-[4rem] mb-6 max-w-8xl mx-auto">
            ...
            <div className="flex flex-col border px-10 py-12 mt-4 text-base bg-white rounded-xl shadow-sm max-w-[329px] text-black">
              ...
              <div className="mt-4 leading-5 capitalize">
                For early startups - 6 + 1 free credits
              </div>
            ...
            <div className="flex flex-col border mt-4 px-10 py-12 text-base bg-white rounded-xl shadow-sm max-w-[329px] text-zinc-500">
              ...
              <div className="mt-4 leading-5 capitalize">
              FOR ESTABLISHED STARTUPS- 25+3 FREE CREDITS
              </div>
              <div className="mt-4 text-5xl font-bold leading-10 text-indigo-400">
                Rs. 2999/-
              </div>
            ...
            <div className="flex flex-col border  px-10 py-12 mt-4 text-base bg-white rounded-xl shadow-sm max-w-[329px] text-zinc-500">
              ...
              <div className="mt-4 leading-5 capitalize">
              FOR ESTABLISED COMPANIES-100+10
              </div>
              <div className="mt-4 text-5xl font-bold leading-10 text-indigo-400">
                Rs. 9999/-
              </div>
          ...
          <div className="flex flex-col border border-gray-200 shadow-lg md:flex-row md:gap-6">
            ...
            <div className="flex flex-col ml-0 md:ml-5 w-full mt-6 md:w-6/12">
              <div className="flex flex-col grow px-5 py-1 text-base font-semibold leading-5 text-zinc-500">
                ...
                ></textarea>
                <div
                  className="justify-center items-center px-16 py-6 mt-5 font-bold text-center text-white uppercase whitespace-nowrap bg-[#3D52A1] tracking-[2px] w-[213px] md:px-5 cursor-pointer"
