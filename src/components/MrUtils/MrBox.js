...
const MrBox = ({ conversation, replyMessage, handleReplyMessageChange, handleSendReply, handleCloseChat, predefinedMessages, currentUserId, setCurrentConversation }) => {
