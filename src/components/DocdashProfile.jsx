                        ...
                        <div className="container max-w-6xl px-5 mx-auto my-10">
                            <div className="overflow-hidden mt-[20px]">
                                                    ...
                                                    <div>
                                                        <div className="flex-shrink w-16 h-16 rounded">
                                                            {doctor.image ? (
                                                                ...
                                                                <div className="flex-shrink w-16 h-16 rounded">
                                                                    {/* Placeholder image */}
                                                                    <img src={Image} className='w-full h-full ' alt="User Profile" />
                                                                </div>
                                                            )}
                                                        </div>
                                            ...
                                            <div className="col-span-3 ... m-auto">
                                                <div className="flex-grow">
                                                    <div className="flex">
                                                        ...
                                                        <p className="text-end px-5 mt-1" onClick={EditCurrentPosition}>
                                                            <FaPen className='text-[#7091E6]' style={{ float: 'inline-end' }} />
                                                        </p>
                                                    </div>
                                ...
                                <div className="flex flex-col p-4 mt-[3rem] bg-white border shadow-2xl rounded">
                                    <div className="flex-grow">
                                        ...
                                        <p className="text-end" onClick={EditAbout}>
                                            <FaPen className='bg-white border text-[#7091E6]' style={{ float: 'inline-end' }} />
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className="bg-white border shadow-2xl rounded p-4">
                                        <div className="flex-grow mb-[2rem] mt-4 ">
                                            <p className="text-end" onClick={EditExperience}>
                                                <FaPen className='bg-white text-[#7091E6]' style={{ float: 'inline-end' }} />
                                            </p>
                                ...
                                <div className="flex justify-end items-center mb-[3rem]">
                                    <button onClick={saveProfile} className="flex gap-1.5 justify-center items-center px-10 py-2 mt-5 text-base font-bold text-center text-white uppercase bg-indigo-800 tracking-[2px] max-md:mt-5">save</button>
                                </div>
                            </div>
                        </div>
                    )}
