...
const AddDoctor = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            // Get the document reference using the docRef's path
            // const documentRef = doc(db, 'doctors', docRef.id);

            // Use the docRef.id as the uid for the doctor
            // const uid = docRef.id;

            // Set the uid field in the document
            // await setDoc(documentRef, { uid }, { merge: true });
    ...
    return (
        <div className="flex">
            ...
            <div className="flex-1 overflow-hidden">
                <AdminNavbar />
                <div className="container max-w-full mx-auto my-5 px-10">
                    <div className="w-full">
                        <form onSubmit={handleSubmit} className="bg-white shadow rounded px-8 pt-6 pb-8 mb-4">
                            <h2 className='text-center text-3xl font-bold my-5'>ADD Doctor</h2>
