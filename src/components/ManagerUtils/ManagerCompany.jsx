            ...
            try {
                ...
                const promises = snapshot.docs.map(async (doc) => {
                    ...
                    if (messageData.sentBy === "doctor") {
                        ...
                        // const timestampString = messageData.timestamp.replace('UTC+5:30', '').trim();
                        // const timestamp = new Date(timestampString);
                        // if (isNaN(timestamp.getTime())) {
                        //     console.error("Invalid timestamp:", messageData.timestamp);
                        //     // Handle the error, e.g., skip processing this message
                        //     return null;
                        // }
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody className="bg-white text-sm divide-y divide-gray-200">
                                        {message.map((message, index) => (
                                            <tr key={message.id} className="border-b py-4 border-gray-200">
