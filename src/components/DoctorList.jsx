...
const DoctorList = () => {
  ...
  const handleViewProfile = (doctor) => {
    if (
      currentUser &&
      (currentUser.emailVerified || currentUser.name || currentUser.username)
    ) {
    ...
    <>
      ...
      <div className="flex flex-col items-center px-16 pt-6 bg-red-50 max-md:px-5">
        ...
        >
          ...
          >
            <div id="doctorinput" className="flex items-center gap-2.5 bg-white rounded max-md:flex-wrap max-md:max-w-full">
              <div id="centerdiv" className="flex items-center gap-2 max-md:flex-col max-md:items-start">
                <input
                  type="text"
                  value={searchQuery}
